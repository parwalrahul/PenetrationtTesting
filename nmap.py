...
def a() :
	...
	def n():
		...
		c=f.read()
		if c=='1' :
			os.system("dialog --no-shadow --no-shadow --title 'Network Scanning' --inputbox 'Enter Your IP Address : ' 10 50 2> /root/Desktop/Project/hello.txt")
			...
			os.system("dialog --no-shadow --no-shadow --title 'Network Scanning' --textbox /root/Desktop/Project/result 20 60")

		if c=='2' :
			os.system("dialog --no-shadow --no-shadow --inputbox 'Enter the number of hosts that you want to scan : ' 10 50 2> /root/Desktop/Project/choice")
			f=open('/root/Desktop/Project/choice','r')
			y=f.read()
			q=int(float(y))
			while q>0 :
				os.system("dialog --no-shadow --no-shadow --inputbox 'Enter Host(s) IP Address : ' 10 50 2>> /root/Desktop/Project/hello.txt")
			...
			os.system("dialog --no-shadow --no-shadow --textbox /root/Desktop/Project/result 20 60")
		...
		if c=='3':
			...
			os.system("nmap -sV "+x+" > /root/Desktop/Project/result")
			os.system("dialog --no-shadow --no-shadow --textbox /root/Desktop/Project/result 20 60")
		...
		if c=='5':
			...
			os.system("dialog --no-shadow --textbox /root/Desktop/Project/result 20 60")
		...
		if c=='6':
			...
			os.system("dialog --no-shadow --textbox /root/Desktop/Project/result 20 100")

		if c=='7' :
			os.system("dialog --no-shadow --menu 'Port Scanning Choices : ' 20 80 7 1 'Single Port Scannning ' 2 'Scan a TCP Port ' 3 'Scan a UDP port' 4 'Scan Discrete Ports' 5 'Scan a range of ports.' 6 'Back' 2> /root/Desktop/Project/choice.txt")
			f=open('/root/Desktop/Project/choice.txt','r')
			d=f.read()
			if d=='1':
				os.system("dialog --no-shadow --inputbox 'Enter Host(s) IP Address : ' 10 50 2> /root/Desktop/Project/hello.txt")
				f=open('/root/Desktop/Project/hello.txt','r')
				x=f.read()
				os.system("dialog --no-shadow --inputbox 'Enter Host(s) Port Number : ' 10 50 2> /root/Desktop/Project/port.txt")
			...
			if d=='4':
				...
				f=open('/root/Desktop/Project/hello.txt','r')
				x=f.read()
				os.system("dialog --no-shadow --inputbox 'Enter the number of ports that you want to scan : ' 10 50 2> /root/Desktop/Project/choice")
				f=open('/root/Desktop/Project/choice','r')
				z=f.read()
				q=int(float(z))
				while q>0 :
					os.system("dialog --no-shadow --inputbox 'Enter Port Number : ' 10 50 2>> /root/Desktop/Project/port.txt")
			...
			if d=='5':
				...
				f=open('/root/Desktop/Project/hello.txt','r')
				x=f.read()
				os.system("dialog --no-shadow --inputbox 'Enter Lower Limit of Port Number : ' 10 50 2>> /root/Desktop/Project/port.txt")
				f1=open('/root/Desktop/Project/port.txt','ab')
				f1.write("-")
				f1.close()
				os.system("dialog --no-shadow --inputbox 'Enter Upper Limit of Port Number : ' 10 50 2>> /root/Desktop/Project/port.txt")	
				f1=open('/root/Desktop/Project/port.txt','r')
				y=f1.readline()
				os.system("dialog --no-shadow --infobox 'Please wait till the processing is being done...' 10 50")
				os.system("nmap -p "+y+" "+x+" > /root/Desktop/Project/result")
		...
		if c=='8':
			os.system("dialog --no-shadow --menu 'Intense Scanning Choices : ' 20 80 7 1 'Intense Scannning ' 2 'Internse Scanning + UDP  ' 3 'Intense Scanning - All TCP ' 4 'Intense Scanning - No Ping ' 5 'Scan a range of ports. ' 6 'Back ' 2> /root/Desktop/Project/choice.txt")
			f=open('/root/Desktop/Project/choice.txt','r')
			d=f.read()
			if d =='1':
				os.system("dialog --no-shadow --inputbox 'Enter Host(s) IP Address : ' 10 50 2> /root/Desktop/Project/hello.txt")
